...
const checkPoster = (path, backdropPath) => {
  let posterHolder;
    if(!path) {
      posterHolder = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTpWR0beQybs6M-Tw1GqxLLUFrbYSz_kggucy4j0MXkqtwaP56V&usqp=CAU';
    } else {
    ...
    <div class="row">
        ...
        <div class="row">
          <div class="col-12 bg-dark actors-bg">
            ...
            <img src="${BACKDROP_BASE_URL + directorOBJ.profile_path}" alt="This director does not like to be in a photo."></li>
            </ul>
...
const setSections = async (genreList) => {
  ...
  actorList.map((actor, index) => {
    ...
    actorDiv.innerHTML = `<img src="${BACKDROP_BASE_URL + actor.profile_path}" alt="${actor.name} poster" class="movie-poster">`;
...
// Filter List
  ...
  let filters = [{name:"Popular", val:"popular"}, {name:"Release Date", val:"release_date"}, {name:"Top Rated", val:"top_rated"}, {name:"Now Playing", val:"now_playing"}, {name:"Upcoming", val:"upcoming"}];
